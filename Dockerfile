...
RUN echo '{ \
    ...
    \n    [ \
    \n      "run", \
    \n      "chmod 777 -R /src/nipype && chmod +x run_builddocs.sh run_examples.sh run_pytests.sh fsl_imglob.py" \
    \n    ], \
    \n    [ \
    \n      "user", \
    \n      "neuro" \
    ...
    \n    ] \
    \n  ], \
    \n  "generation_timestamp": "2017-11-03 12:04:25", \
